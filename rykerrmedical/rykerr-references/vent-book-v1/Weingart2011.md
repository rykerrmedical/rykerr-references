---
layout: default
title: Reference - Weingart2011
permalink: /Weingart2011.html
original_url: https://emcrit.org/emcrit/origins-of-the-dope-mnemonic/
archive_url: https://web.archive.org/web/https://emcrit.org/emcrit/origins-of-the-dope-mnemonic/
---

<div class="reference-page">
  <h1>Reference: Weingart2011</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://emcrit.org/emcrit/origins-of-the-dope-mnemonic/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://emcrit.org/emcrit/origins-of-the-dope-mnemonic/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://emcrit.org/emcrit/origins-of-the-dope-mnemonic/';
  } else {
    url = 'https://web.archive.org/web/https://emcrit.org/emcrit/origins-of-the-dope-mnemonic/';
  }
