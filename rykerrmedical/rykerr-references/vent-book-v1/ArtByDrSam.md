---
layout: default
title: Reference - ArtByDrSam
permalink: /ArtByDrSam.html
original_url: https://www.fiverr.com/artby_drsam?source=order_page_summary_seller_link
archive_url: https://web.archive.org/web/https://www.fiverr.com/artby_drsam?source=order_page_summary_seller_link
---

<div class="reference-page">
  <h1>Reference: ArtByDrSam</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.fiverr.com/artby_drsam?source=order_page_summary_seller_link" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.fiverr.com/artby_drsam?source=order_page_summary_seller_link" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.fiverr.com/artby_drsam?source=order_page_summary_seller_link';
  } else {
    url = 'https://web.archive.org/web/https://www.fiverr.com/artby_drsam?source=order_page_summary_seller_link';
  }
