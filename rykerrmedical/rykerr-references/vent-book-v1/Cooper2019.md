...
<div class="reference-page">
  <h1>Reference: Cooper2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.ncbi.nlm.nih.gov/books/NBK430743/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/books/NBK430743/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  if (type === 'original') {
    ...
    url = 'https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/books/NBK430743/';
  }
