---
layout: default
title: Reference - Silverston2016
permalink: /Silverston2016.html
original_url: https://geekymedics.com/pulse-oximetry/
archive_url: https://web.archive.org/web/https://geekymedics.com/pulse-oximetry/
---

<div class="reference-page">
  <h1>Reference: Silverston2016</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://geekymedics.com/pulse-oximetry/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://geekymedics.com/pulse-oximetry/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://geekymedics.com/pulse-oximetry/';
  } else {
    url = 'https://web.archive.org/web/https://geekymedics.com/pulse-oximetry/';
  }
