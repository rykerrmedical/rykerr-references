---
layout: default
title: Reference - Wingfield2012a
permalink: /Wingfield2012a.html
original_url: https://www.rykerrmedical.com/wingfield-ob-video
archive_url: https://web.archive.org/web/https://www.rykerrmedical.com/wingfield-ob-video
---

<div class="reference-page">
  <h1>Reference: Wingfield2012a</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.rykerrmedical.com/wingfield-ob-video" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.rykerrmedical.com/wingfield-ob-video" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.rykerrmedical.com/wingfield-ob-video';
  } else {
    url = 'https://web.archive.org/web/https://www.rykerrmedical.com/wingfield-ob-video';
  }
