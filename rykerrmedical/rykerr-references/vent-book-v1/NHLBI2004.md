---
layout: default
title: Reference - NHLBI2004
permalink: /NHLBI2004.html
original_url: https://www.nejm.org/doi/full/10.1056/NEJMoa032193
archive_url: https://web.archive.org/web/https://www.nejm.org/doi/full/10.1056/NEJMoa032193
---

<div class="reference-page">
  <h1>Reference: NHLBI2004</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.nejm.org/doi/full/10.1056/NEJMoa032193" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.nejm.org/doi/full/10.1056/NEJMoa032193" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.nejm.org/doi/full/10.1056/NEJMoa032193';
  } else {
    url = 'https://web.archive.org/web/https://www.nejm.org/doi/full/10.1056/NEJMoa032193';
  }
