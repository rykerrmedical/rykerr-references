---
layout: default
title: Reference - Lauria2019
permalink: /Lauria2019.html
original_url: https://www.emra.org/emresident/article/cuff-leak/
archive_url: https://web.archive.org/web/https://www.emra.org/emresident/article/cuff-leak/
---

<div class="reference-page">
  <h1>Reference: Lauria2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.emra.org/emresident/article/cuff-leak/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.emra.org/emresident/article/cuff-leak/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.emra.org/emresident/article/cuff-leak/';
  } else {
    url = 'https://web.archive.org/web/https://www.emra.org/emresident/article/cuff-leak/';
  }
