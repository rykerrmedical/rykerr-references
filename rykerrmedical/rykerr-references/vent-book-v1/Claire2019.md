---
layout: default
title: Reference - Claire2019
permalink: /Claire2019.html
original_url: https://wikem.org/wiki/Lung_recruitment_maneuver
archive_url: https://web.archive.org/web/https://wikem.org/wiki/Lung_recruitment_maneuver
---

<div class="reference-page">
  <h1>Reference: Claire2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://wikem.org/wiki/Lung_recruitment_maneuver" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://wikem.org/wiki/Lung_recruitment_maneuver" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://wikem.org/wiki/Lung_recruitment_maneuver';
  } else {
    url = 'https://web.archive.org/web/https://wikem.org/wiki/Lung_recruitment_maneuver';
  }
