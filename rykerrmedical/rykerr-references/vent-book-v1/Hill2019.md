...
<div class="reference-page">
  <h1>Reference: Hill2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="http://www.tamingthesru.com/blog/2019/9/7/is-a-bag-enough" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/http://www.tamingthesru.com/blog/2019/9/7/is-a-bag-enough" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'http://www.tamingthesru.com/blog/2019/9/7/is-a-bag-enough';
  } else {
    url = 'https://web.archive.org/web/http://www.tamingthesru.com/blog/2019/9/7/is-a-bag-enough';
  }
