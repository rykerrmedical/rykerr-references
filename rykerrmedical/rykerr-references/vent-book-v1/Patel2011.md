---
layout: default
title: Reference - Patel2011
permalink: /Patel2011.html
original_url: https://www.atsjournals.org/doi/full/10.1164/rccm.201102-0273CI
archive_url: https://web.archive.org/web/https://www.atsjournals.org/doi/full/10.1164/rccm.201102-0273CI
---

<div class="reference-page">
  <h1>Reference: Patel2011</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.atsjournals.org/doi/full/10.1164/rccm.201102-0273CI" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.atsjournals.org/doi/full/10.1164/rccm.201102-0273CI" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.atsjournals.org/doi/full/10.1164/rccm.201102-0273CI';
  } else {
    url = 'https://web.archive.org/web/https://www.atsjournals.org/doi/full/10.1164/rccm.201102-0273CI';
  }
