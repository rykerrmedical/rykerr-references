---
layout: default
title: Reference - WeingartVentHandout
permalink: /WeingartVentHandout.html
original_url: https://emcrit.org/wp-content/uploads/vent-handout.pdf
archive_url: https://web.archive.org/web/https://emcrit.org/wp-content/uploads/vent-handout.pdf
---

<div class="reference-page">
  <h1>Reference: WeingartVentHandout</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://emcrit.org/wp-content/uploads/vent-handout.pdf" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://emcrit.org/wp-content/uploads/vent-handout.pdf" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://emcrit.org/wp-content/uploads/vent-handout.pdf';
  } else {
    url = 'https://web.archive.org/web/https://emcrit.org/wp-content/uploads/vent-handout.pdf';
  }
