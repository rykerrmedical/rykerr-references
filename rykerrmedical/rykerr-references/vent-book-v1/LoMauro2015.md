---
layout: default
title: Reference - LoMauro2015
permalink: /LoMauro2015.html
original_url: https://breathe.ersjournals.com/content/11/4/297
archive_url: https://web.archive.org/web/https://breathe.ersjournals.com/content/11/4/297
---

<div class="reference-page">
  <h1>Reference: LoMauro2015</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://breathe.ersjournals.com/content/11/4/297" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://breathe.ersjournals.com/content/11/4/297" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://breathe.ersjournals.com/content/11/4/297';
  } else {
    url = 'https://web.archive.org/web/https://breathe.ersjournals.com/content/11/4/297';
  }
