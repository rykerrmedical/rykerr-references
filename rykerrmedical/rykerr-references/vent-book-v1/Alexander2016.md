---
layout: default
title: Reference - Alexander2016
permalink: /Alexander2016.html
original_url: http://www.emdocs.net/approach-tachypnea-ed-setting/
archive_url: https://web.archive.org/web/http://www.emdocs.net/approach-tachypnea-ed-setting/
---

<div class="reference-page">
  <h1>Reference: Alexander2016</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="http://www.emdocs.net/approach-tachypnea-ed-setting/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/http://www.emdocs.net/approach-tachypnea-ed-setting/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'http://www.emdocs.net/approach-tachypnea-ed-setting/';
  } else {
    url = 'https://web.archive.org/web/http://www.emdocs.net/approach-tachypnea-ed-setting/';
  }
