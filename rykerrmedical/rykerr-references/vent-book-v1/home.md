...
permalink: /home.html
original_url: https://www.rykerrmedical.com
archive_url: https://web.archive.org/web/https://www.rykerrmedical.com
---
...
<div class="reference-page">
  ...
  <div class="reference-options">
    <div class="option-card">
      ...
      <a href="https://www.rykerrmedical.com" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.rykerrmedical.com" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.rykerrmedical.com';
  } else {
    url = 'https://web.archive.org/web/https://www.rykerrmedical.com';
  }
