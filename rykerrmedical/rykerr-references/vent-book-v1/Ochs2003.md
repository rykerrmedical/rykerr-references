...
<div class="reference-page">
  <h1>Reference: Ochs2003</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.atsjournals.org/doi/full/10.1164/rccm.200308-1107OC" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.atsjournals.org/doi/full/10.1164/rccm.200308-1107OC" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.atsjournals.org/doi/full/10.1164/rccm.200308-1107OC';
  } else {
    url = 'https://web.archive.org/web/https://www.atsjournals.org/doi/full/10.1164/rccm.200308-1107OC';
  }
