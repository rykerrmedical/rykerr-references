---
layout: default
title: Reference - Prevent2018
permalink: /Prevent2018.html
original_url: https://jamanetwork.com/journals/jama/fullarticle/2710774
archive_url: https://web.archive.org/web/https://jamanetwork.com/journals/jama/fullarticle/2710774
---

<div class="reference-page">
  <h1>Reference: Prevent2018</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://jamanetwork.com/journals/jama/fullarticle/2710774" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://jamanetwork.com/journals/jama/fullarticle/2710774" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://jamanetwork.com/journals/jama/fullarticle/2710774';
  } else {
    url = 'https://web.archive.org/web/https://jamanetwork.com/journals/jama/fullarticle/2710774';
  }
