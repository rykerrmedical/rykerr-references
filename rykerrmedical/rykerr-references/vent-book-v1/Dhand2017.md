---
layout: default
title: Reference - Dhand2017
permalink: /Dhand2017.html
original_url: http://rc.rcjournal.com/content/62/10/1343.full
archive_url: https://web.archive.org/web/http://rc.rcjournal.com/content/62/10/1343.full
---

<div class="reference-page">
  <h1>Reference: Dhand2017</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="http://rc.rcjournal.com/content/62/10/1343.full" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/http://rc.rcjournal.com/content/62/10/1343.full" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'http://rc.rcjournal.com/content/62/10/1343.full';
  } else {
    url = 'https://web.archive.org/web/http://rc.rcjournal.com/content/62/10/1343.full';
  }
