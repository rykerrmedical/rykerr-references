---
layout: default
title: Reference - Tobin2013
permalink: /Tobin2013.html
original_url: https://accessanesthesiology.mhmedical.com/book.aspx?bookid=520
archive_url: https://web.archive.org/web/https://accessanesthesiology.mhmedical.com/book.aspx?bookid=520
---

<div class="reference-page">
  <h1>Reference: Tobin2013</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://accessanesthesiology.mhmedical.com/book.aspx?bookid=520" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://accessanesthesiology.mhmedical.com/book.aspx?bookid=520" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://accessanesthesiology.mhmedical.com/book.aspx?bookid=520';
  } else {
    url = 'https://web.archive.org/web/https://accessanesthesiology.mhmedical.com/book.aspx?bookid=520';
  }
