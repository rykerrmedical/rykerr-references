---
layout: default
title: Reference - NinjaNerdRespiratory
permalink: /NinjaNerdRespiratory.html
original_url: https://www.youtube.com/playlist?list=PLTF9h-T1TcJjdJppplKVsgPWNQ_beElaG
archive_url: https://web.archive.org/web/https://www.youtube.com/playlist?list=PLTF9h-T1TcJjdJppplKVsgPWNQ_beElaG
---

<div class="reference-page">
  <h1>Reference: NinjaNerdRespiratory</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.youtube.com/playlist?list=PLTF9h-T1TcJjdJppplKVsgPWNQ_beElaG" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.youtube.com/playlist?list=PLTF9h-T1TcJjdJppplKVsgPWNQ_beElaG" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.youtube.com/playlist?list=PLTF9h-T1TcJjdJppplKVsgPWNQ_beElaG';
  } else {
    url = 'https://web.archive.org/web/https://www.youtube.com/playlist?list=PLTF9h-T1TcJjdJppplKVsgPWNQ_beElaG';
  }
