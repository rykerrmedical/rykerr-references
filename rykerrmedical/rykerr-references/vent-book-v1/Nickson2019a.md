---
layout: default
title: Reference - Nickson2019a
permalink: /Nickson2019a.html
original_url: https://litfl.com/high-airway-and-alveolar-pressures/
archive_url: https://web.archive.org/web/https://litfl.com/high-airway-and-alveolar-pressures/
---

<div class="reference-page">
  <h1>Reference: Nickson2019a</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://litfl.com/high-airway-and-alveolar-pressures/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://litfl.com/high-airway-and-alveolar-pressures/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://litfl.com/high-airway-and-alveolar-pressures/';
  } else {
    url = 'https://web.archive.org/web/https://litfl.com/high-airway-and-alveolar-pressures/';
  }
