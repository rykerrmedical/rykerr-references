---
layout: default
title: Reference - Mason2019
permalink: /Mason2019.html
original_url: https://www.youtube.com/playlist?list=PLKbsytZxJw7_ObYvaAtmrzbFDUIzJvdU2
archive_url: https://web.archive.org/web/https://www.youtube.com/playlist?list=PLKbsytZxJw7_ObYvaAtmrzbFDUIzJvdU2
---

<div class="reference-page">
  <h1>Reference: Mason2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.youtube.com/playlist?list=PLKbsytZxJw7_ObYvaAtmrzbFDUIzJvdU2" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.youtube.com/playlist?list=PLKbsytZxJw7_ObYvaAtmrzbFDUIzJvdU2" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.youtube.com/playlist?list=PLKbsytZxJw7_ObYvaAtmrzbFDUIzJvdU2';
  } else {
    url = 'https://web.archive.org/web/https://www.youtube.com/playlist?list=PLKbsytZxJw7_ObYvaAtmrzbFDUIzJvdU2';
  }
