---
layout: default
title: Reference - NHLBI2005image
permalink: /NHLBI2005image.html
original_url: http://www.ardsnet.org/tools.shtml
archive_url: https://web.archive.org/web/http://www.ardsnet.org/tools.shtml
---

<div class="reference-page">
  <h1>Reference: NHLBI2005image</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="http://www.ardsnet.org/tools.shtml" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/http://www.ardsnet.org/tools.shtml" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'http://www.ardsnet.org/tools.shtml';
  } else {
    url = 'https://web.archive.org/web/http://www.ardsnet.org/tools.shtml';
  }
