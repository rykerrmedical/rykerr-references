...
<div class="reference-page">
  <h1>Reference: Arjo2020</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.arjo.com/en-us/products/medical-beds/critical-care/rotoprone/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.arjo.com/en-us/products/medical-beds/critical-care/rotoprone/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.arjo.com/en-us/products/medical-beds/critical-care/rotoprone/';
  } else {
    url = 'https://web.archive.org/web/https://www.arjo.com/en-us/products/medical-beds/critical-care/rotoprone/';
  }
