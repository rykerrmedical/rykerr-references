---
layout: default
title: Reference - Betts2013Sxn22.4
permalink: /Betts2013Sxn22.4.html
original_url: https://openstax.org/books/anatomy-and-physiology/pages/22-4-gas-exchange
archive_url: https://web.archive.org/web/https://openstax.org/books/anatomy-and-physiology/pages/22-4-gas-exchange
---

<div class="reference-page">
  <h1>Reference: Betts2013Sxn22.4</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://openstax.org/books/anatomy-and-physiology/pages/22-4-gas-exchange" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://openstax.org/books/anatomy-and-physiology/pages/22-4-gas-exchange" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://openstax.org/books/anatomy-and-physiology/pages/22-4-gas-exchange';
  } else {
    url = 'https://web.archive.org/web/https://openstax.org/books/anatomy-and-physiology/pages/22-4-gas-exchange';
  }
