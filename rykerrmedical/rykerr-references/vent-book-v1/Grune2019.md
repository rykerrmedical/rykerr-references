---
layout: default
title: Reference - Grune2019
permalink: /Grune2019.html
original_url: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6658629/?report=classic
archive_url: https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6658629/?report=classic
---

<div class="reference-page">
  <h1>Reference: Grune2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6658629/?report=classic" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6658629/?report=classic" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6658629/?report=classic';
  } else {
    url = 'https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6658629/?report=classic';
  }
