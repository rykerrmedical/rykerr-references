---
layout: default
title: Reference - Kumar2015
permalink: /Kumar2015.html
original_url: https://emmedonline.com/airway/simv
archive_url: https://web.archive.org/web/https://emmedonline.com/airway/simv
---

<div class="reference-page">
  <h1>Reference: Kumar2015</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://emmedonline.com/airway/simv" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://emmedonline.com/airway/simv" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://emmedonline.com/airway/simv';
  } else {
    url = 'https://web.archive.org/web/https://emmedonline.com/airway/simv';
  }
