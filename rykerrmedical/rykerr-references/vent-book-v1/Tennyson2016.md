---
layout: default
title: Reference - Tennyson2016
permalink: /Tennyson2016.html
original_url: https://escholarship.org/uc/item/72p7845j
archive_url: https://web.archive.org/web/https://escholarship.org/uc/item/72p7845j
---

<div class="reference-page">
  <h1>Reference: Tennyson2016</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://escholarship.org/uc/item/72p7845j" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://escholarship.org/uc/item/72p7845j" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://escholarship.org/uc/item/72p7845j';
  } else {
    url = 'https://web.archive.org/web/https://escholarship.org/uc/item/72p7845j';
  }
