---
layout: default
title: Reference - Clinical2019
permalink: /Clinical2019.html
original_url: http://www.rykerrmedical.com/crash2009
archive_url: https://web.archive.org/web/http://www.rykerrmedical.com/crash2009
---

<div class="reference-page">
  <h1>Reference: Clinical2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="http://www.rykerrmedical.com/crash2009" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/http://www.rykerrmedical.com/crash2009" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'http://www.rykerrmedical.com/crash2009';
  } else {
    url = 'https://web.archive.org/web/http://www.rykerrmedical.com/crash2009';
  }
