---
layout: default
title: Reference - Maher2019
permalink: /Maher2019.html
original_url: https://www.youtube.com/watch?v=X0VpueL6Chk
archive_url: https://web.archive.org/web/https://www.youtube.com/watch?v=X0VpueL6Chk
---

<div class="reference-page">
  <h1>Reference: Maher2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.youtube.com/watch?v=X0VpueL6Chk" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.youtube.com/watch?v=X0VpueL6Chk" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.youtube.com/watch?v=X0VpueL6Chk';
  } else {
    url = 'https://web.archive.org/web/https://www.youtube.com/watch?v=X0VpueL6Chk';
  }
