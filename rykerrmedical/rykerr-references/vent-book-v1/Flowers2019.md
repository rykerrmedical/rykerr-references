---
layout: default
title: Reference - Flowers2019
permalink: /Flowers2019.html
original_url: https://openstax.org/books/chemistry-atoms-first-2e/pages/1-introduction
archive_url: https://web.archive.org/web/https://openstax.org/books/chemistry-atoms-first-2e/pages/1-introduction
---

<div class="reference-page">
  <h1>Reference: Flowers2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://openstax.org/books/chemistry-atoms-first-2e/pages/1-introduction" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://openstax.org/books/chemistry-atoms-first-2e/pages/1-introduction" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  if (type === 'original') {
    ...
    url = 'https://web.archive.org/web/https://openstax.org/books/chemistry-atoms-first-2e/pages/1-introduction';
  }
