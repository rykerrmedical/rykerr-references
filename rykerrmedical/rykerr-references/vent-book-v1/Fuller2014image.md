---
layout: default
title: Reference - Fuller2014image
permalink: /Fuller2014image.html
original_url: https://clinicalgate.com/general-principles-of-mechanical-ventilation/
archive_url: https://web.archive.org/web/https://clinicalgate.com/general-principles-of-mechanical-ventilation/
---

<div class="reference-page">
  <h1>Reference: Fuller2014image</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://clinicalgate.com/general-principles-of-mechanical-ventilation/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://clinicalgate.com/general-principles-of-mechanical-ventilation/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://clinicalgate.com/general-principles-of-mechanical-ventilation/';
  } else {
    url = 'https://web.archive.org/web/https://clinicalgate.com/general-principles-of-mechanical-ventilation/';
  }
