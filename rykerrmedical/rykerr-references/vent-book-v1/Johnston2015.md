---
layout: default
title: Reference - Johnston2015
permalink: /Johnston2015.html
original_url: https://www.pftforum.com/blog/anatomic-dead-space/
archive_url: https://web.archive.org/web/https://www.pftforum.com/blog/anatomic-dead-space/
---

<div class="reference-page">
  <h1>Reference: Johnston2015</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.pftforum.com/blog/anatomic-dead-space/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.pftforum.com/blog/anatomic-dead-space/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.pftforum.com/blog/anatomic-dead-space/';
  } else {
    url = 'https://web.archive.org/web/https://www.pftforum.com/blog/anatomic-dead-space/';
  }
