---
layout: default
title: Reference - Lodeserto2018
permalink: /Lodeserto2018.html
original_url: https://rebelem.com/simplifying-mechanical-ventilation-part/
archive_url: https://web.archive.org/web/https://rebelem.com/simplifying-mechanical-ventilation-part/
---

<div class="reference-page">
  <h1>Reference: Lodeserto2018</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://rebelem.com/simplifying-mechanical-ventilation-part/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://rebelem.com/simplifying-mechanical-ventilation-part/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://rebelem.com/simplifying-mechanical-ventilation-part/';
  } else {
    url = 'https://web.archive.org/web/https://rebelem.com/simplifying-mechanical-ventilation-part/';
  }
