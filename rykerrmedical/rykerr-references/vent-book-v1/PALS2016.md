...
<div class="reference-page">
  <h1>Reference: PALS2016</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://shopcpr.heart.org/courses/pals" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://shopcpr.heart.org/courses/pals" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://shopcpr.heart.org/courses/pals';
  } else {
    url = 'https://web.archive.org/web/https://shopcpr.heart.org/courses/pals';
  }
