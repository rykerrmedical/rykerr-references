---
layout: default
title: Reference - Speller2018
permalink: /Speller2018.html
original_url: https://teachmephysiology.com/respiratory-system/gas-exchange/gas-exchange/
archive_url: https://web.archive.org/web/https://teachmephysiology.com/respiratory-system/gas-exchange/gas-exchange/
---

<div class="reference-page">
  <h1>Reference: Speller2018</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://teachmephysiology.com/respiratory-system/gas-exchange/gas-exchange/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://teachmephysiology.com/respiratory-system/gas-exchange/gas-exchange/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://teachmephysiology.com/respiratory-system/gas-exchange/gas-exchange/';
  } else {
    url = 'https://web.archive.org/web/https://teachmephysiology.com/respiratory-system/gas-exchange/gas-exchange/';
  }
