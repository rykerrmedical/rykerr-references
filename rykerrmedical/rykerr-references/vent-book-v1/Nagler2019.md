---
layout: default
title: Reference - Nagler2019
permalink: /Nagler2019.html
original_url: https://www.rykerrmedical.com/nagler2019
archive_url: https://web.archive.org/web/https://www.rykerrmedical.com/nagler2019
---

<div class="reference-page">
  <h1>Reference: Nagler2019</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.rykerrmedical.com/nagler2019" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.rykerrmedical.com/nagler2019" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.rykerrmedical.com/nagler2019';
  } else {
    url = 'https://web.archive.org/web/https://www.rykerrmedical.com/nagler2019';
  }
