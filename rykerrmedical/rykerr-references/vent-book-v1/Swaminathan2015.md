---
layout: default
title: Reference - Swaminathan2015
permalink: /Swaminathan2015.html
original_url: https://rebelem.com/is-too-much-supplemental-o2-harmful-in-copd-exacerbations/
archive_url: https://web.archive.org/web/https://rebelem.com/is-too-much-supplemental-o2-harmful-in-copd-exacerbations/
---

<div class="reference-page">
  <h1>Reference: Swaminathan2015</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://rebelem.com/is-too-much-supplemental-o2-harmful-in-copd-exacerbations/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://rebelem.com/is-too-much-supplemental-o2-harmful-in-copd-exacerbations/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://rebelem.com/is-too-much-supplemental-o2-harmful-in-copd-exacerbations/';
  } else {
    url = 'https://web.archive.org/web/https://rebelem.com/is-too-much-supplemental-o2-harmful-in-copd-exacerbations/';
  }
