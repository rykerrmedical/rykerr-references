---
layout: default
title: Reference - Ollie2015
permalink: /Ollie2015.html
original_url: https://www.youtube.com/watch?v=RsV31UlH3yU
archive_url: https://web.archive.org/web/https://www.youtube.com/watch?v=RsV31UlH3yU
---

<div class="reference-page">
  <h1>Reference: Ollie2015</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.youtube.com/watch?v=RsV31UlH3yU" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.youtube.com/watch?v=RsV31UlH3yU" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.youtube.com/watch?v=RsV31UlH3yU';
  } else {
    url = 'https://web.archive.org/web/https://www.youtube.com/watch?v=RsV31UlH3yU';
  }
