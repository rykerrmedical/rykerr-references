---
layout: default
title: Reference - Hartland2015
permalink: /Hartland2015.html
original_url: http://rc.rcjournal.com/content/60/4/609
archive_url: https://web.archive.org/web/http://rc.rcjournal.com/content/60/4/609
---

<div class="reference-page">
  <h1>Reference: Hartland2015</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="http://rc.rcjournal.com/content/60/4/609" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/http://rc.rcjournal.com/content/60/4/609" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'http://rc.rcjournal.com/content/60/4/609';
  } else {
    url = 'https://web.archive.org/web/http://rc.rcjournal.com/content/60/4/609';
  }
