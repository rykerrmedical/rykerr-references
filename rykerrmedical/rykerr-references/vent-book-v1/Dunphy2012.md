---
layout: default
title: Reference - Dunphy2012
permalink: /Dunphy2012.html
original_url: https://www.youtube.com/watch?v=m-d2IQC-sbM
archive_url: https://web.archive.org/web/https://www.youtube.com/watch?v=m-d2IQC-sbM
---

<div class="reference-page">
  <h1>Reference: Dunphy2012</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.youtube.com/watch?v=m-d2IQC-sbM" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.youtube.com/watch?v=m-d2IQC-sbM" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.youtube.com/watch?v=m-d2IQC-sbM';
  } else {
    url = 'https://web.archive.org/web/https://www.youtube.com/watch?v=m-d2IQC-sbM';
  }
