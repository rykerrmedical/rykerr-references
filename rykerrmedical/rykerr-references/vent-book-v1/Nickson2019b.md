---
layout: default
title: Reference - Nickson2019b
permalink: /Nickson2019b.html
original_url: https://litfl.com/open-lung-approach-to-ventilation/
archive_url: https://web.archive.org/web/https://litfl.com/open-lung-approach-to-ventilation/
---

<div class="reference-page">
  <h1>Reference: Nickson2019b</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://litfl.com/open-lung-approach-to-ventilation/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://litfl.com/open-lung-approach-to-ventilation/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://litfl.com/open-lung-approach-to-ventilation/';
  } else {
    url = 'https://web.archive.org/web/https://litfl.com/open-lung-approach-to-ventilation/';
  }
