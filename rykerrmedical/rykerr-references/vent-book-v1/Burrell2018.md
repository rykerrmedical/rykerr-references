---
layout: default
title: Reference - Burrell2018
permalink: /Burrell2018.html
original_url: https://www.thebottomline.org.uk/summaries/icm/prevent/
archive_url: https://web.archive.org/web/https://www.thebottomline.org.uk/summaries/icm/prevent/
---

<div class="reference-page">
  <h1>Reference: Burrell2018</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.thebottomline.org.uk/summaries/icm/prevent/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.thebottomline.org.uk/summaries/icm/prevent/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.thebottomline.org.uk/summaries/icm/prevent/';
  } else {
    url = 'https://web.archive.org/web/https://www.thebottomline.org.uk/summaries/icm/prevent/';
  }
