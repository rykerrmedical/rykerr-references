---
layout: default
title: Reference - Henderson2014
permalink: /Henderson2014.html
original_url: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4173887/
archive_url: https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4173887/
---

<div class="reference-page">
  <h1>Reference: Henderson2014</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4173887/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4173887/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4173887/';
  } else {
    url = 'https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4173887/';
  }
