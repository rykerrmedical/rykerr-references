---
layout: default
title: Reference - TheYoungOrthopod
permalink: /TheYoungOrthopod.html
original_url: https://www.youtube.com/channel/UCAIelr1RR0R6vfUgo0JVaXw
archive_url: https://web.archive.org/web/https://www.youtube.com/channel/UCAIelr1RR0R6vfUgo0JVaXw
---

<div class="reference-page">
  <h1>Reference: TheYoungOrthopod</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.youtube.com/channel/UCAIelr1RR0R6vfUgo0JVaXw" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.youtube.com/channel/UCAIelr1RR0R6vfUgo0JVaXw" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.youtube.com/channel/UCAIelr1RR0R6vfUgo0JVaXw';
  } else {
    url = 'https://web.archive.org/web/https://www.youtube.com/channel/UCAIelr1RR0R6vfUgo0JVaXw';
  }
