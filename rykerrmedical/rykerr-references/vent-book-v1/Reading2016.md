---
layout: default
title: Reference - Reading2016
permalink: /Reading2016.html
original_url: https://www.ausmed.com/cpd/articles/oxygen-flow-rate-and-fio2
archive_url: https://web.archive.org/web/https://www.ausmed.com/cpd/articles/oxygen-flow-rate-and-fio2
---

<div class="reference-page">
  <h1>Reference: Reading2016</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://www.ausmed.com/cpd/articles/oxygen-flow-rate-and-fio2" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://www.ausmed.com/cpd/articles/oxygen-flow-rate-and-fio2" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://www.ausmed.com/cpd/articles/oxygen-flow-rate-and-fio2';
  } else {
    url = 'https://web.archive.org/web/https://www.ausmed.com/cpd/articles/oxygen-flow-rate-and-fio2';
  }
