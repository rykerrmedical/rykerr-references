---
layout: default
title: Reference - Weingart2009
permalink: /Weingart2009.html
original_url: https://emcrit.org/emcrit/tube-severe-acidosis/
archive_url: https://web.archive.org/web/https://emcrit.org/emcrit/tube-severe-acidosis/
---

<div class="reference-page">
  <h1>Reference: Weingart2009</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="https://emcrit.org/emcrit/tube-severe-acidosis/" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/https://emcrit.org/emcrit/tube-severe-acidosis/" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  let url;
  if (type === 'original') {
    url = 'https://emcrit.org/emcrit/tube-severe-acidosis/';
  } else {
    url = 'https://web.archive.org/web/https://emcrit.org/emcrit/tube-severe-acidosis/';
  }
