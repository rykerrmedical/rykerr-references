---
layout: default
title: Reference - NHLBI2005
permalink: /NHLBI2005.html
original_url: http://www.ardsnet.org/files/ventilator_protocol_2008-07.pdf
archive_url: https://web.archive.org/web/http://www.ardsnet.org/files/ventilator_protocol_2008-07.pdf
---

<div class="reference-page">
  <h1>Reference: NHLBI2005</h1>
  
  <div class="reference-options">
    <div class="option-card">
      <h2>📄 View Original Source</h2>
      <p>Access the reference at its original location</p>
      <a href="http://www.ardsnet.org/files/ventilator_protocol_2008-07.pdf" target="_blank" class="btn btn-primary">Open Original</a>
    ...
    <div class="option-card">
      ...
      <a href="https://web.archive.org/web/http://www.ardsnet.org/files/ventilator_protocol_2008-07.pdf" target="_blank" class="btn btn-primary">Open Archive</a>
...
function loadEmbed(type) {
  ...
  if (type === 'original') {
    ...
    url = 'https://web.archive.org/web/http://www.ardsnet.org/files/ventilator_protocol_2008-07.pdf';
  }
